...
// 0 modo espera
// 1 Eliminar archivo de datos y pasar al modo 2
// 2 Medir continuamente
// 3 Detener mediciones
// 4 Se renombra el alchivo de mediciones y se transmite via serial las mediciones tomadas
// 5 Reiniciar ESP32
// 6 Leer datos desde el el archivo de mediciones renombrado
